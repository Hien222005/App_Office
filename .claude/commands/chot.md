...
## Cách làm
1. `node agent/tinh-trang.mjs` — còn việc sếp chưa duyệt thì **dừng**, in danh sách.
2. `node agent/ban-nhap.mjs ghi-het` — chép cả loạt, chỉ file trong phạm vi.
...
4. `node agent/dong-phien.mjs <id-phiên> "tóm tắt"`.
